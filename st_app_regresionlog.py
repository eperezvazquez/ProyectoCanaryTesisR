...
"""
#MODELO DE REGRESION
df_modelo = pd.read_csv('https://raw.githubusercontent.com/eperezvazquez/ProyectoCanaryTesisR/main/src/DataModeloRegresion.csv', engine='python', sep=',', quotechar='"', error_bad_lines=False)
